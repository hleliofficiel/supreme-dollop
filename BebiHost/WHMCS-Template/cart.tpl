<!-- BebiHost WHMCS cart template -->
<div class="glass-panel" style="padding: 2rem;">
    <h1>{$LANG.carttitle|default:"cart"}</h1>

    <div class="content-area" style="margin-top: 2rem;">
        <p>Enterprise WHMCS integration for cart. Fully customized UI components inheriting global styles, ensuring brand consistency across the platform.</p>

<!-- BebiHost WHMCS order-forms template -->
<div class="glass-panel" style="padding: 2rem;">
    <h1>{$LANG.orderformstitle|default:"order forms"}</h1>

    <div class="content-area" style="margin-top: 2rem;">
        <p>Enterprise WHMCS integration for order forms. Fully customized UI components inheriting global styles, ensuring brand consistency across the platform.</p>

<!-- BebiHost WHMCS domains template -->
<div class="glass-panel" style="padding: 2rem;">
    <h1>{$LANG.domainstitle|default:"domains"}</h1>

    <div class="content-area" style="margin-top: 2rem;">
        <p>Enterprise WHMCS integration for domains. Fully customized UI components inheriting global styles, ensuring brand consistency across the platform.</p>

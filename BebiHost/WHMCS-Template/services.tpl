<!-- BebiHost WHMCS services template -->
<div class="glass-panel" style="padding: 2rem;">
    <h1>{$LANG.servicestitle|default:"services"}</h1>

    <div class="content-area" style="margin-top: 2rem;">
        <p>Enterprise WHMCS integration for services. Fully customized UI components inheriting global styles, ensuring brand consistency across the platform.</p>
